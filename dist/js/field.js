...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["b"] = getOpeningHoursData;
...
Component.options.__file = "resources/js/components/WeekTable.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-20dcfd42", Component.options)
  } else {
    hotAPI.reload("data-v-20dcfd42", Component.options)
  }
...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-nova-opening-hours-field', __webpack_require__(5));
    Vue.component('detail-nova-opening-hours-field', __webpack_require__(9));
    Vue.component('form-nova-opening-hours-field', __webpack_require__(14));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__func__ = __webpack_require__(1);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return _extends({}, Object(__WEBPACK_IMPORTED_MODULE_0__func__["b" /* getOpeningHoursData */])(this.field.value));
    }
});
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return WEEK_DAYS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EMPTY_WEEK; });
...
var render = function() {
  ...
  return _c(
    ...
    _vm._l(_vm.openingHours, function(intervals, dayName) {
      return _c("boolean-icon", {
        key: dayName,
        attrs: { value: intervals.length }
      })
    }),
    1
  )
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__WeekTable__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__WeekTable___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__WeekTable__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: { WeekTable: __WEBPACK_IMPORTED_MODULE_0__WeekTable___default.a },

    props: ['resource', 'resourceName', 'resourceId', 'field'],

    data: function data() {
        return _extends({}, Object(__WEBPACK_IMPORTED_MODULE_1__func__["b" /* getOpeningHoursData */])(this.field.value));
    }
});
...
var render = function() {
  ...
  return _c(
    "table",
    { staticClass: "openingHours weekTable table w-full" },
    _vm._l(_vm.openingHours, function(intervals, dayName) {
      return _c("tr", [
        _c("td", [_vm._v(_vm._s(_vm.translateDayName(dayName)))]),
        _vm._v(" "),
        _c("td", [
          _vm.openingHours[dayName].length
            ? _c(
                "div",
                _vm._l(intervals, function(interval, intervalIndex) {
                  return _c("div", { staticClass: "interval" }, [
                    _vm.editable
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.openingHours[dayName][intervalIndex],
                                expression:
                                  "openingHours[dayName][intervalIndex]"
                              }
                            ],
                            staticClass:
                      ...
                      : _c("div", [_vm._v(_vm._s(interval))])
                  ])
                }),
                0
              )
            : _c("div", [_vm._v(_vm._s(_vm.__("Closed")))])
        ]),
        _vm._v(" "),
        _vm.editable
          ? _c("td", [
              _c(
                "button",
                {
                  ...
                  on: {
                    click: function($event) {
                      $event.preventDefault()
                      return _vm.addInterval(dayName)
                    }
                  }
                },
                [_vm._v("+")]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-20dcfd42", module.exports)
  }
}
  ...
  return _c(
    ...
    [
      _c(
        ...
        [
          _c("week-table", {
            attrs: { openingHours: _vm.openingHours, editable: false }
          })
        ],
        1
      )
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__WeekTable__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__WeekTable___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__WeekTable__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: { WeekTable: __WEBPACK_IMPORTED_MODULE_1__WeekTable___default.a },
    ...
    data: function data() {
        return _extends({}, Object(__WEBPACK_IMPORTED_MODULE_2__func__["b" /* getOpeningHoursData */])(this.field.value));
    },
